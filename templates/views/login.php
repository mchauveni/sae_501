                        ...
                        <form action="/login" method="POST">
                            ...
                            <div class="form_container">
                                <div class="input_container">
                                    <input required type="text" id="loginEmail" name="email" autofocus="<?php echo $this->error == "email" || $this->error == "empty" ?>" value="<?php echo $this->email ?>"/>
                                ...
                                <div class="input_container">
                                    <input class="password_havetoggle" required type="password" id="loginPassword" name="password" autofocus="<?php echo $this->error == "password" ?>"/>
