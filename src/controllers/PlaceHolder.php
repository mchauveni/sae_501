<?php
    ...
    class PlaceHolder extends Controller {
        public function pdf () : string {
            ...
            $pdf->Cell(0,10, iconv("UTF-8", "", $req["file"] ?? "fichier_offre.pdf"), 10, 0, 'center');
            $pdf->Ln(12);
            $pdf->SetFont('helvetica','B',18);
            $pdf->Cell(0,10, iconv("UTF-8", "", $req["title"] ?? "Placeholder PDF"), 10, 0, 'center');
            $pdf->Ln(12);
            ...
            $pdf->Cell(0,10, iconv("UTF-8", "", $req["comm"] ?? "Commentaires de l'offre"), 10, 0, 'center');
            return $pdf->Output('I', iconv("UTF-8", "", $req["title"] ?? "Placeholder PDF"), false);
        }
    }
?>